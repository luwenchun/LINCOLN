      ...
      <div className={'wrap'}>
          ...
          <div className={'content'}>
            ...
            <div className={'row'}>
              ...
              <div className={'rc'}>{this.state.detailInfo['userName']}</div>
            </div>

            <div className={'row'}>
              <div className={'rt'}>联系电话：</div>
              <div className={'rc'}>{this.state.detailInfo['userPhone']}</div>
              <div className={'toolbox'}>
                <button type="button" className={'btn-primary'} onClick={this.btnAction.bind(this,'detail')}>详情</button>
              </div>
            </div>
